...
This is extracted from the V10 quadruped firmware so the receiver work can be understood without the robot state machine, inverse kinematics, or servo control code around it.
