...
$stageTwo.PolicyGateMaxSwingContact = 0.90
$stageTwo.PolicyGateMinSwingClearanceM = 0.001
$stageTwo.PolicyGateMinEachCadFootClearanceM = 0.001
...
$stageTwo.GaitContactRewardScale = 1.0
$stageTwo.SwingContactPenaltyScale = -0.5
$stageTwo.FootClearanceRewardScale = 1.5
$stageTwo.ReferenceTrackingRewardScale = 0.0
$stageTwo.ReferenceMseRewardScale = 0.0
...
$stageThree.PolicyGateMaxSwingContact = 0.80
$stageThree.PolicyGateMinSwingClearanceM = 0.002
$stageThree.PolicyGateMinEachCadFootClearanceM = 0.003
